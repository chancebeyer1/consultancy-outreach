...
export const MOCK_DRAFT_ROWS: DraftReviewRow[] = [
  {
    ...
    hooks: [
      hook(
        ...
        "She's wrestling with the exact orchestration tradeoff I solved at StratEdge",
        5,
      ),
      hook(
        "hiring_signal",
      ...
      hook(
        ...
        "Same stack as StratEdge — instant credibility",
        3,
      ),
    ],
    drafts: [
      {
        ...
        step_index: 0,
        hook: null,
        body: "your post about ripping out LangGraph — we hit the same wall at StratEdge after a similar honeymoon period. ended up rolling our own state machine. open to swap notes.",
        edited_body: null,
        status: "draft",
      ...
      },
      {
        ...
        step_index: 1,
        hook: null,
        body: "thanks for the accept. quick context — just spent 4 months as agent engineer at a Series A AI startup, the orchestration rewrite you posted about is basically what we shipped. happy to share architecture notes if useful: https://your-domain.com",
        edited_body: null,
        status: "draft",
        rejection_reason: null,
        variant: null,
...

  {
    ...
    drafts: [
      ...
      },
      {
        ...
        step_index: 1,
        hook: null,
        body: "thanks for the connect. context: I'm an independent contractor, just wrapped 4 months as agent engineer at a Series A AI startup. given Pivotworks' AI Studio is fresh, figured worth introducing myself before you're fully staffed. architecture notes here: https://your-domain.com",
        edited_body: null,
        status: "draft",
        rejection_reason: null,
        variant: null,
    ...
    drafts: [
      {
        ...
        step_index: 0,
        hook: null,
        body: "noticed you popped by my profile last week — appreciated. just shipped a similar agent (calendaring tools, function calling, the works) at a Series A. happy to be in each other's orbit.",
        edited_body: null,
        status: "draft",
        rejection_reason: null,
        variant: null,
      ...
      },
      {
        ...
        step_index: 1,
        hook: null,
        body: "thanks for the accept. your Treble calendaring agent case study is the cleanest writeup I've come across — looked at the eval approach in particular. happy to compare notes; just shipped the same general thing at a Series A AI startup: https://your-domain.com",
        edited_body: null,
        status: "draft",
        rejection_reason: null,
        variant: null,
      ...
      },
      {
        ...
        step_index: 2,
        hook: null,
        body: "Subject: treble's calendaring agent + my stratedge build\n\nyour case study on the calendaring agent — best writeup I've come across this quarter, especially the eval section.\n\nspent the last 4 months building a similar agent (different vertical, same general shape — tool calling, trace replay, the works) at a Series A AI startup. full breakdown at https://your-domain.com.\n\nif Treble is taking on contractors I'd love a chat. no pressure.\n\n—you\n\n(reply \"no thanks\" and I'll never write again)",
        edited_body: null,
        status: "draft",
        rejection_reason: null,
        variant: null,
