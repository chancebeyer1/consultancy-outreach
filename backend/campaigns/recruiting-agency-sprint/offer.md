# Offer — AI agents for recruiting agencies (research-led)
...
I build **AI agents that handle the repetitive top-of-desk work** so recruiters spend time on
candidates and clients, not admin:
- **Sourcing** — pulling and shortlisting candidates against a role's must-haves
- **Screening** — first-pass qualification, knockout questions, summarizing CVs to a brief
- **Candidate + client outreach** — drafting personalized first messages and follow-ups at
  volume (in the recruiter's voice)
- **Scheduling + status** — booking screens and keeping candidates/clients updated

The pitch (when earned): *a custom agent trained on your desk's roles and tone, so one
recruiter covers the throughput of three.*

## The angle

Recruiters live in outreach and screening, and they already feel the volume tax — which makes
"how do you run your desk" an honest question, not a setup. They also *get* AI agents faster
than almost any buyer, because the work is so clearly automatable.
