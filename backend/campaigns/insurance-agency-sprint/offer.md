...
- **Document intake + chasing** — collecting dec pages, loss runs, applications, signed
  forms from clients and carriers without the endless email ping-pong
- **Quote + proposal prep** — drafting ACORDs, COIs, and proposal docs from the data already
  on file
- **Renewal comms** — drafting the renewal outreach, reminders, and status updates
- **Client status updates** — answering "where's my COI / is my policy bound yet" instantly

The pitch (when earned): *a custom agent that handles your agency's specific paperwork
flow, so your producers sell instead of chase documents.*
