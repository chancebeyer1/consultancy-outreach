...
VENUES: list[tuple] = [
    ("The Gaslite", "Santa Monica · Wilshire", T1, "thegaslite", None, None,
     ...
     "Karaoke 365 days a year and an hour wait on weekends. Everyone leaves with a hangover and nothing to show for it. I'm putting vintage style photo booths in a few westside bars right now. It costs the bar nothing, I handle all the upkeep, and you keep a cut of every strip. Feels made for the moment right after someone nails their song. Is that something you decide in house or is it the owner's call?"),
    ("Tavern on Main", "Santa Monica · Main St", T1, "tavernonmainsm", "info@tavernonmainsm.com", "photo booth for the Tavern?",
     ...
     "You've got the only pool table on Main Street plus karaoke nights, so groups already end their night with you. I'm starting a small photo booth route in westside bars. The booth costs you nothing, I install it and keep it running, and the house gets a share of every vend. Strips print with your logo on them. Does something like that go through you or through ownership?\n\nThanks,\nChance"),
    ("Circle Bar", "Santa Monica · Main St", T1, "circlebarsm", "info@circlebar-sm.com", None,
     ...
     "The Halo and that 8K laser rig, you clearly rebuilt the room for nights people want to remember. I'm placing vintage style photo booths in a few westside bars. Free to the venue, I service everything, and the bar takes a cut of each strip. Red lit strips from Circle Bar would end up on a lot of fridges. Who's the right person to run that by?"),
    ("Hinano Cafe", "Venice · Washington Blvd", T1, "hinanovenice", "info@hinanocafevenice.com", None,
     ...
     "Bands three nights a week, sawdust on the floor, sixty years of stories. And no photo evidence unless someone remembers their phone. I'm starting a small photo booth route on the westside. The booth is free to you, I keep it running, and the bar takes a cut of every strip. Is there a corner by the pool tables that could fit one?"),
    ("Ye Olde King's Head", "Santa Monica · downtown", T1, "yeoldekingshead", "info@yeoldekingshead.com", "a photo booth that pays the pub",
     ...
     "You rented a photo booth for the 50th anniversary. I'd like to put one in permanently that pays the pub instead of costing it. I'm starting a small route of vintage style booths in westside bars. Free to the venue, I handle install and upkeep, and King's Head takes a cut of every strip with your branding on the prints. Who's the right person there to run this by?\n\nThanks,\nChance"),
    ("Townhouse & Del Monte Speakeasy", "Venice · Windward Ave", T1, "townhousevenice", "info@townhousevenice.com", "photo booth for the Del Monte?",
     ...
     "A speakeasy that ran liquor down a dumbwaiter deserves analog souvenirs. I'm starting a small photo booth route on the westside. Vintage style machine, no cost to the venue, I service it, and Townhouse takes a cut of every strip. The jazz and burlesque crowds downstairs would keep it busy. Who should I talk to about the space?\n\nCheers,\nChance"),
    ("The Brig", "Venice · Abbot Kinney", T1, "thebrigvenice", "info@thebrig.com", None,
     ...
     "Mojitos at a shot and beer dive is already a story people tell. The photo strip is the proof that should go with it. I'm starting a photo booth route on the westside. Costs the Brig nothing, I handle everything, you take a cut of each strip. Your call or the owner's?"),
    ("Roosterfish", "Venice · Abbot Kinney", T1, "roosterfish_venice", "RoosterfishAK@gmail.com", "photo booth idea for Roosterfish",
     ...
     "Forty plus years of history, back from a two year closure, disco nights until 2. Roosterfish strips would be instant keepsakes. I'm starting a small route of vintage style photo booths in westside bars. Free to the venue, I maintain it, the bar shares in every vend, and prints carry your branding. Is that something you all decide in house?\n\nThanks,\nChance"),
    ("Prince O' Whales", "Playa del Rey · Culver Blvd", T1, "princeowhales", "prince.o.whales.management@gmail.com", "photo booth for PoW?",
     ...
     "Karaoke Tuesdays and Thursdays with Kiki, ping pong right in the bar. PoW is already built for groups who want proof of the night. I'm starting a small photo booth route on the westside. The booth costs you nothing, I install and service it, and the bar takes a cut of every strip. Is there a corner that could fit a phone booth sized footprint?\n\nThanks,\nChance"),
    ("Q's Billiard Club", "Brentwood · Wilshire", T1, "qsbilliards", "contact@qsbilliardclub.com", "photo booth for Q's?",
     ...
     "Hour long waits for a table on weekends means a room full of people looking for something to do between games. I'm starting a photo booth route on the westside. Vintage style booth at zero cost to the venue, I run and service the machine, and Q's takes a share of every strip. Who's the right person to run this by?\n\nThanks,\nChance"),
    ("The Nickel Mine", "West LA · Santa Monica Blvd", T1, "nickelmine", "thenickelmine@gmail.com", "photo booth for the Nickel Mine?",
     ...
     "Game days packed to the gills plus a hidden room in back. That's the exact crowd photo booths were built for. I'm starting a small booth route on the westside. The machine is free to the bar, I handle upkeep, and you get a cut of each vend. Does that decision sit with you or ownership?\n\nThanks,\nChance"),
    ("The Garage on Motor Ave", "Palms · Motor Ave", T1, "garageonmotor", "info@garageonmotor.com", "photo booth for the Garage?",
     ...
     "Fight nights, karaoke Fridays and Saturdays, and the Motor Club in back. You've got three different crowds a week who'd feed a photo booth. I'm starting a small route of vintage style booths. Free to the venue, I service everything, and the Garage takes a cut per strip. Is that your call or the owner's?\n\nThanks,\nChance"),
    ("Harvelle's", "Santa Monica · 4th St", T1, "harvellessm", "info@harvelles.com", "photo booth for Harvelle's?",
     ...
     "Burlesque and blues since 1931 and no booth for the after show photo. Black and white strips belong in that room. I'm starting a photo booth route on the westside. Vintage style machine, no cost to you, I install and maintain it, and Harvelle's takes a cut of every strip. Who makes that call there?\n\nThanks,\nChance"),
    ("Blind Barber", "Culver City · Washington Blvd", T1, "blindbarber_la", None, None,
     ...
     "A barbershop up front, grilled cheese in the back, a secret comedy night once a month. The whole place is already an analog experience. I'm starting a photo booth route on the westside. The booth is free to the venue, I keep it running, and you take a share of every strip. Who makes that call for the Culver room?"),
    ("The Cinema Bar", "Culver City · Sepulveda", T1, "thecinemabar_", None, None,
     ...
     "The world's smallest honky tonk might be the one westside room where I honestly can't promise the booth fits. But free live music seven nights a week deserves photo strips. I'm starting a booth route, zero cost to the bar, service included, and the house takes a cut per vend. Is there truly nine square feet to spare in there?"),
    ("No Smoking Bar", "Culver City Arts District", T1, "nosmokingbar", None, None,
     ...
     "Taking over the Mandrake space and keeping the arts crowd. A coin operated photo booth would sit against those cabin panels like it was always there. I'm starting a small route on the westside. The booth is free to the venue, I handle all upkeep, and the bar takes a cut of each strip. Your call or the owners'?"),
    ("Cozy Inn", "Culver City · Washington Pl", T1, "_cozyinn", None, None,
     ...
     "unknown",
     "A shuffleboard table in the middle of the room and your own parking lot. Cozy Inn is the kind of bar photo booths were invented for. I'm starting a small route. The booth costs you nothing, I maintain it, and the house gets a cut of every strip. Would the room take a phone booth sized footprint somewhere?"),
    ("Chez Jay", "Santa Monica · Ocean Ave", T1, "chezjay1959", "peanuts@chezjays.com", "photo booth for Chez Jay?",
     ...
     "A bar peanut that went to the moon sets a high standard for souvenirs. A photo strip from Chez Jay is the earthbound version. I'm starting a vintage style booth route on the westside. Free to the venue, I handle service, and the house shares in every vend. Is the front room or the Backyard even booth sized?\n\nThanks,\nChance"),
    ...
    ("The Venice West", "Venice · Lincoln Blvd", T2, "thevenicewest", "events@venicemusicgroup.com", "photo booth for the Venice West?",
     ...
     "Between national acts and line dancing nights you've got crowds who want proof they were there. I'm starting a photo booth route on the westside. Vintage style machine, free to the venue, I maintain it, and you take a share per strip. It fits in a lobby corner. Is that a venue decision or does Venice Music Group make it?\n\nThanks,\nChance"),
    ("The Lincoln", "Venice · Lincoln Blvd", T2, "thelincolnvenice", "info@thelincolnvenice.com", "photo booth for The Lincoln?",
     ...
     "unknown",
     "A Model T in the decor and doors that open at 7pm. The Lincoln is a pure night bar, which is exactly when booths earn. I'm starting a small route on the westside. Vintage style photo booth, zero cost to you, I service it, and the house takes a cut of each vend. Is there a corner that could take one?\n\nThanks,\nChance"),
    ("Baja Cantina", "Marina del Rey · Washington", T2, "bajacantinamdr", None, None,
     ...
     "Fifty years of margaritas and live music every weekend. Baja strips would be on fridges all over the Marina. I'm starting a photo booth route on the westside. The booth is free to the venue, I handle everything, and the house shares each vend. Who makes that call there?"),
    ("Mo's Place", "Playa del Rey · Culver Blvd", T2, "mosplace_pdr", None, None,
     ...
     "New management adding trivia, patio DJs, and live music. Sounds like the exact moment to add a photo booth too. I'm starting a small route. Vintage style, free to the bar, I service everything, and the house takes a cut per strip. Is that your call or the owners'?"),
    ("Joxer Daly's", "Culver City · Washington Blvd", T2, "joxer_d", None, None,
     ...
     "Thursday karaoke and Premier League mornings. Two crowds, both wanting very different photos. I'm starting a small photo booth route on the westside. The booth is free to the pub, I maintain it, and the house shares every vend. Would Joxer's have a corner for one?"),
    ("Scarlet Lady Saloon", "Culver City · Sepulveda", T2, "scarlet_lady_saloon", None, None,
     ...
     "unknown",
     "Karaoke five nights a week and a Saints bar on Sundays. That room generates more photo worthy moments than most clubs. I'm starting a booth route on the westside. Vintage style, costs you nothing, I keep it running, and you take a cut of each strip. Who decides that kind of thing there?"),
    ("The Daily Pint", "Santa Monica · Pico", T2, "thedailypintsm", "thedailypint@yahoo.com", "photo booth for the Pint?",
     ...
     "unknown",
     "Cask ale on hand pumps and a five hundred bottle whiskey wall. The Pint is already an analog bar and a film look photo booth fits that. I'm starting a small route on the westside. Free to the venue, I service it, and the house takes a share per vend. Is there floor space anywhere near the shuffleboard?\n\nThanks,\nChance"),
    ("Sonny McLean's", "Santa Monica · Wilshire", T2, "sonnymcleans", None, None,
     ...
     "The number one Pats bar on the West Coast. Every Boston win in that room ends in group photos that never get printed. I'm starting a photo booth route on the westside. Vintage style booth, free to the bar, all service on me, and the house takes a cut per strip. Your call or the owner's?"),
    ("Santa Monica Brew Works", "Santa Monica · Colorado Ave", T2, "santamonicabrewworks", "info@santamonicabrewworks.com", "photo booth for the taproom?",
     ...
     "An 11.5 foot jumbotron ahead of the World Cup, you're clearly investing in reasons for people to stay. A photo booth is the cheapest one there is. Free to the taproom, I install and maintain it, and you share in each vend. Who's the right person for that conversation?\n\nThanks,\nChance"),
    ("Alibi Room", "Del Rey · W Washington", T2, "alibiroomla", "info@alibiroomla.com", "photo booth for Alibi Room?",
     ...
     "Kogi tacos out of the kitchen and a patio behind glass doors. Date night central. I'm starting a vintage style photo booth route on the westside. No cost to the venue, I run the machine, and the house takes a cut per strip. Is that your decision or an ownership one?\n\nThanks,\nChance"),
    ("Accomplice Bar", "Mar Vista · Grand View", T2, "accomplice_bar", "info@littlefattyla.com", "photo booth for Accomplice?",
     ...
     "unknown",
     "A Spirited Awards top ten bar with a chicken fat mezcal signature. People already treat a visit as an event and strips make it a souvenir. I'm starting a small booth route. Free to you, I service it, and the house shares each vend. Who makes that call for Accomplice?\n\nThanks,\nChance"),
    ("The Wellesbourne", "West LA · Pico", T2, "thewellesbourne", None, None,
     ...
     "unknown",
     "A book lined manor room with live jazz. A vintage black and white photo booth is about the only machine that wouldn't break the spell. I'm starting a small route on the westside. Free to the venue, I handle upkeep, and the house takes a cut per strip. Who decides on additions like that?"),
    ("Dots Space LA", "Sawtelle Japantown", T2, "dotsspace_la", "info@dotsspacela.com", "photo booth for Dots?",
     ...
     "unknown",
     "Four themed karaoke rooms and 4am closes. Everyone leaves mid adrenaline and empty handed. A coin operated photo booth by the stage fixes that. Free to you, I install and maintain it, and Dots takes a share of every strip. Is that your call?\n\nThanks,\nChance"),
    ("Purple Orchid", "El Segundo · Richmond St", T2, "purpleorchidtikilounge", None, None,
     ...
     "Packed Fridays under the tiki decor since 2001. A vintage photo booth in that room would never be empty. I'm starting a small route. Costs the bar nothing, I service it, and the house takes a cut per strip. Would there be a corner for one?"),
    ("Melody Bar & Grill", "Westchester · Sepulveda", T2, "melodylax", None, None,
     ...
     "unknown",
     "Wednesday karaoke, comedy nights, and the same corner since 1952. Melody's the kind of room photo strips were made in. I'm starting a booth route. Vintage style, free to the bar, I keep it running, and the house shares each vend. Who makes that call there?"),
    ("Father's Office", "Culver City · Helms", T3, "fathersofficeofficial", "info@fathersoffice.com", "photo booth for the Helms patio crowd?",
     ...
     "The Helms room stays packed almost every night. While people wait on burgers a photo booth pays rent. I'm starting a small route of vintage style booths on the westside. No cost to the venue, I service everything, and the house takes a cut per strip. Does that route through the group or the GM?\n\nThanks,\nChance"),
    ("Firestone Walker Propagator", "Marina del Rey · Washington", T3, "firestonewalker_propagator", None, None,
     ...
     "Venice only beers out of the R&D brewhouse. The Propagator is the one Firestone room quirky enough for a vintage photo booth. I'm starting a small route. Free to the venue, I handle service, and the house shares each vend. Is that a local GM decision or corporate?"),
    ("LA Ale Works Culver City", "Culver City · Ivy Station", T3, "laaleworks", "info@laaleworks.com", "photo booth for the Ivy Station taproom?",
     ...
     "Time Out 'local hit'",
     "Trivia Tuesdays with organized teams and the E Line at your door. Group crowds are what feed photo booths. I'm starting a small route on the westside. The booth is free to the taproom, serviced by me, with a revenue share on every strip. GM call or ownership?\n\nThanks,\nChance"),
    ("Barney's Beanery Westwood", "Westwood Village", T3, "barneysbeaneryww", "info@barneysbeanery.com", "photo booth for the Westwood room?",
     ...
     "Billiards, arcade games, and Thursday karaoke two blocks from campus. Students print nothing and this is the one thing they'd print. I'm starting a vintage style photo booth route. Free to the venue, I maintain it, and the house takes a cut per vend. Who decides for the Westwood location?\n\nThanks,\nChance"),
    ("Rocco's Tavern Westwood", "Westwood Village", T3, "roccoswestwood", None, None,
     ...
     "Live band karaoke plus every UCLA game. That's two photo hungry crowds a week. I'm starting a photo booth route on the westside. Vintage style booth, free to the bar, service included, and the house shares each strip. Is that decided in house or at the group level?"),
    ("The Chestnut Club", "Santa Monica · 14th St", T3, "thechestnutclub", "marketing@happytoserveyou.com", "photo booth for Chestnut?",
     ...
     "unknown",
     "A room with deliberately zero TVs. A vintage photo booth is the one machine that agrees with that philosophy. I'm starting a small route on the westside. Free to the venue, I handle everything, and the house takes a cut per strip. Who would make that call for Chestnut?\n\nThanks,\nChance"),
    ("Library Alehouse", "Santa Monica · Main St", T3, "libraryalehouse", "info@libraryalehouse.com", "photo booth for the Alehouse?",
     ...
     "unknown",
     "One of LA's first craft beer bars, freshly restored. A film look booth fits the wood paneling better than any TV would. I'm starting a small route on the westside. Free to the venue, I service it, and the house shares each vend. Is that an owners' decision or a GM one?\n\nThanks,\nChance"),
    ("The Brixton", "Santa Monica · Pico", T3, "thebrixtonsm", "events@thebrixtonsm.com", "photo booth for the Brixton?",
     ...
     "unknown",
     "Latin Nights and bottomless Saturdays. Groups who already dress for photos. I'm starting a vintage style photo booth route on the westside. Free to the venue, I keep it running, and the house takes a cut per strip. Who's the right person there?\n\nThanks,\nChance"),
    ("The Mulberry", "Sawtelle Japantown", T3, "themulberryla", None, None,
     ...
     "The only bar pouring past midnight on Sawtelle. Last call crowds leave with nothing to show for it. I'm starting a small photo booth route. Vintage style, no cost to the venue, service included, and the house shares each vend. Too new to say yes or exactly the right time?"),
    ("El Segundo Brewing", "El Segundo · Main St", T3, "esbcbrews", "info@elsegundobrewing.com", "photo booth for the taproom?",
     ...
     "unknown",
     "Home of the Broken Skull IPA. The pilgrimage crowd wants proof they made it to the source. I'm starting a small photo booth route. Free to you, I maintain it, and the house takes a cut per strip. Is there floor space for a phone booth sized corner?\n\nThanks,\nChance"),
    ("Brewport Tap House", "El Segundo · Main St", T3, "brewporttaphouse", None, None,
     ...
     "unknown",
     "Sixty self pour taps and trivia with BUDDS. You've built the interactive taproom and a coin operated photo booth is the missing station. I'm starting a small route. Free to the venue, I service it, and the house shares each vend. GM call or ownership?"),
]
