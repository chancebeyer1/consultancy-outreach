...
VENUES: list[tuple] = [
    ('The Gaslite', 'Santa Monica · Wilshire', T1, 'thegaslite', None, None,
     ...
     "Karaoke 365 days a year and hour long waits on weekends. I put vintage style photo booths in westside bars. Free to the bar, I handle all upkeep, you keep a cut of every strip. Is that your call or the owner's?"),
    ('Tavern on Main', 'Santa Monica · Main St', T1, 'tavernonmainsm', 'info@tavernonmainsm.com', 'photo booth for the Tavern?',
     ...
     "Main Street's only pool table plus karaoke nights. I put photo booths in westside bars. Free to you, I install and service everything, and the house gets a share of every vend with your logo on the strips. Does this go through you or ownership?\n\nThanks,\nChance"),
    ('Circle Bar', 'Santa Monica · Main St', T1, 'circlebarsm', 'info@circlebar-sm.com', None,
     ...
     "Congrats on the reopen, the Halo looks unreal. I place vintage style photo booths in westside bars. Free to the venue, I service everything, the bar takes a cut of each strip. Who's the right person to run this by?"),
    ('Hinano Cafe', 'Venice · Washington Blvd', T1, 'hinanovenice', 'info@hinanocafevenice.com', None,
     ...
     'Bands three nights a week and sixty years of history. I put old school photo booths in westside bars. Free to you, I keep it running, the bar takes a cut of every strip. Is there a corner by the pool tables that fits one?'),
    ("Ye Olde King's Head", 'Santa Monica · downtown', T1, 'yeoldekingshead', 'info@yeoldekingshead.com', 'a photo booth that pays the pub',
     ...
     "You rented a photo booth for the 50th. I install them permanently and the pub gets paid instead. Free to you, I handle everything, King's Head takes a cut of every strip. Who's the right person to run this by?\n\nThanks,\nChance"),
    ('Townhouse & Del Monte Speakeasy', 'Venice · Windward Ave', T1, 'townhousevenice', 'info@townhousevenice.com', 'photo booth for the Del Monte?',
     ...
     'Jazz and burlesque nightly in the Del Monte. A vintage photo booth belongs down there. I place them free, I service everything, Townhouse takes a cut of every strip. Who should I talk to about the space?\n\nThanks,\nChance'),
    ('The Brig', 'Venice · Abbot Kinney', T1, 'thebrigvenice', 'info@thebrig.com', None,
     ...
     "Seventy years on Abbot Kinney and Saturday crowds out the door. I put vintage style photo booths in westside bars. Costs the Brig nothing, I handle everything, you take a cut of each strip. Your call or the owner's?"),
    ('Roosterfish', 'Venice · Abbot Kinney', T1, 'roosterfish_venice', 'RoosterfishAK@gmail.com', 'photo booth idea for Roosterfish',
     ...
     'Disco nights until 2 deserve photo strips. I place vintage style booths in westside bars. Free to the venue, I maintain it, the bar shares every vend, your branding on the prints. Is this decided in house?\n\nThanks,\nChance'),
    ("Prince O' Whales", 'Playa del Rey · Culver Blvd', T1, 'princeowhales', 'prince.o.whales.management@gmail.com', 'photo booth for PoW?',
     ...
     'Karaoke twice a week and ping pong in the bar. I put photo booths in westside bars. Free to you, I install and service it, PoW takes a cut of every strip. Is there a corner that fits a phone booth footprint?\n\nThanks,\nChance'),
    ("Q's Billiard Club", 'Brentwood · Wilshire', T1, 'qsbilliards', 'contact@qsbilliardclub.com', "photo booth for Q's?",
     ...
     "Hour long table waits on weekends. A photo booth gives people something to do between games. Free to Q's, I run and service it, you take a share of every strip. Who's the right person for this?\n\nThanks,\nChance"),
    ('The Nickel Mine', 'West LA · Santa Monica Blvd', T1, 'nickelmine', 'thenickelmine@gmail.com', 'photo booth for the Nickel Mine?',
     ...
     'Game days there are packed to the gills. I put vintage style photo booths in westside bars. Free to the bar, I handle upkeep, you get a cut of each vend. Is that you or ownership?\n\nThanks,\nChance'),
    ('The Garage on Motor Ave', 'Palms · Motor Ave', T1, 'garageonmotor', 'info@garageonmotor.com', 'photo booth for the Garage?',
     ...
     "Fight nights, weekend karaoke, and the Motor Club. I put photo booths in westside bars. Free to the venue, I service everything, the Garage takes a cut per strip. Your call or the owner's?\n\nThanks,\nChance"),
    ("Harvelle's", 'Santa Monica · 4th St', T1, 'harvellessm', 'info@harvelles.com', "photo booth for Harvelle's?",
     ...
     "Shows seven nights a week since 1931. Black and white photo strips belong in that room. I place booths free, service everything, Harvelle's takes a cut of every strip. Who makes that call?\n\nThanks,\nChance"),
    ('Blind Barber', 'Culver City · Washington Blvd', T1, 'blindbarber_la', None, None,
     ...
     'The speakeasy in back is perfect for a vintage photo booth. I place them free, keep them running, and the bar takes a share of every strip. Who makes that call for the Culver room?'),
    ('The Cinema Bar', 'Culver City · Sepulveda', T1, 'thecinemabar_', None, None,
     ...
     'Live music seven nights and no cover. I put photo booths in westside bars. Free to you, service included, the house takes a cut per vend. Is there nine square feet to spare in there?'),
    ('No Smoking Bar', 'Culver City Arts District', T1, 'nosmokingbar', None, None,
     ...
     "A coin operated photo booth would fit those cabin panels perfectly. I place them free, handle all upkeep, and the bar takes a cut of each strip. Your call or the owners'?"),
    ('Cozy Inn', 'Culver City · Washington Pl', T1, '_cozyinn', None, None,
     ...
     'Shuffleboard in the middle of the room and your own lot. I put photo booths in bars like yours. Free, I maintain it, the house gets a cut of every strip. Is there space for a phone booth footprint?'),
    ('Chez Jay', 'Santa Monica · Ocean Ave', T1, 'chezjay1959', 'peanuts@chezjays.com', 'photo booth for Chez Jay?',
     ...
     'Your peanut went to the moon. A photo strip is the souvenir everyone else can take home. I place vintage style booths free, handle service, the house shares every vend. Would the front room or Backyard fit one?\n\nThanks,\nChance'),
    ('The Waterfront Venice', 'Venice · boardwalk', T2, 'thewaterfrontvenice', None, None,
     ...
     'Trivia Thursdays, weekend DJs, and boardwalk traffic all day. I put photo booths in westside venues. Free to you, service included, the house takes a cut of every strip. Who runs decisions like this?'),
    ('The Venice West', 'Venice · Lincoln Blvd', T2, 'thevenicewest', 'events@venicemusicgroup.com', 'photo booth for the Venice West?',
     ...
     'Shows most nights and line dancing in between. I place photo booths in westside venues, lobby corner size. Free to you, I maintain it, you take a share per strip. Venue decision or Venice Music Group?\n\nThanks,\nChance'),
    ('The Lincoln', 'Venice · Lincoln Blvd', T2, 'thelincolnvenice', 'info@thelincolnvenice.com', 'photo booth for The Lincoln?',
     ...
     'Doors at 7 and pours till 2. Night bars are where photo booths earn. Free to you, I service it, the house takes a cut of each vend. Is there a corner that fits one?\n\nThanks,\nChance'),
    ('Baja Cantina', 'Marina del Rey · Washington', T2, 'bajacantinamdr', None, None,
     ...
     'Fifty years of margaritas and weekend live music. I put photo booths in westside bars. Free to the venue, I handle everything, the house shares each vend. Who makes that call?'),
    ("Mo's Place", 'Playa del Rey · Culver Blvd', T2, 'mosplace_pdr', None, None,
     ...
     "Saw new management is adding trivia and DJs. Add a photo booth too. Free to the bar, I service everything, the house takes a cut per strip. Your call or the owners'?"),
    ("Joxer Daly's", 'Culver City · Washington Blvd', T2, 'joxer_d', None, None,
     ...
     "Thursday karaoke and Premier League mornings. I put photo booths in westside pubs. Free to you, I maintain it, the house shares every vend. Would Joxer's have a corner for one?"),
    ('Scarlet Lady Saloon', 'Culver City · Sepulveda', T2, 'scarlet_lady_saloon', None, None,
     ...
     'Karaoke five nights a week. I put photo booths in westside bars. Free to you, I keep it running, you take a cut of each strip. Who decides that there?'),
    ('The Daily Pint', 'Santa Monica · Pico', T2, 'thedailypintsm', 'thedailypint@yahoo.com', 'photo booth for the Pint?',
     ...
     'Cask ale and a five hundred bottle whiskey wall. A film look photo booth fits the Pint. Free to you, I service it, the house takes a share per vend. Any floor space near the shuffleboard?\n\nThanks,\nChance'),
    ("Sonny McLean's", 'Santa Monica · Wilshire', T2, 'sonnymcleans', None, None,
     ...
     "Every Pats win in that room ends in photos. I put photo booths in westside bars. Free to you, all service on me, the house takes a cut per strip. Your call or the owner's?"),
    ('Santa Monica Brew Works', 'Santa Monica · Colorado Ave', T2, 'santamonicabrewworks', 'info@santamonicabrewworks.com', 'photo booth for the taproom?',
     ...
     "The World Cup jumbotron says you're investing in the taproom. A photo booth is the cheapest add there is. Free to you, I install and maintain it, you share each vend. Who's the right person?\n\nThanks,\nChance"),
    ('Alibi Room', 'Del Rey · W Washington', T2, 'alibiroomla', 'info@alibiroomla.com', 'photo booth for Alibi Room?',
     ...
     'Kogi out of the kitchen and date night crowds. I put vintage style photo booths in westside spots. Free to you, I run the machine, the house takes a cut per strip. You or ownership?\n\nThanks,\nChance'),
    ('Accomplice Bar', 'Mar Vista · Grand View', T2, 'accomplice_bar', 'info@littlefattyla.com', 'photo booth for Accomplice?',
     ...
     'Top ten cocktail bar in the country. Strips make the visit a souvenir. Free booth, I service it, the house shares each vend. Who makes that call?\n\nThanks,\nChance'),
    ('The Wellesbourne', 'West LA · Pico', T2, 'thewellesbourne', None, None,
     ...
     'A black and white photo booth fits the library room. I place them free, handle upkeep, the house takes a cut per strip. Who decides on additions like that?'),
    ('Dots Space LA', 'Sawtelle Japantown', T2, 'dotsspace_la', 'info@dotsspacela.com', 'photo booth for Dots?',
     ...
     'Karaoke rooms until 3am and nothing to take home. I put photo booths by stages like yours. Free to you, I maintain it, Dots shares every strip. Your call?\n\nThanks,\nChance'),
    ('Purple Orchid', 'El Segundo · Richmond St', T2, 'purpleorchidtikilounge', None, None,
     ...
     'Packed Fridays under the tiki decor. I put vintage photo booths in bars. Free to you, I service it, the house takes a cut per strip. Is there a corner for one?'),
    ('Melody Bar & Grill', 'Westchester · Sepulveda', T2, 'melodylax', None, None,
     ...
     'Karaoke, comedy, and the same corner since 1952. I put photo booths in rooms like Melody. Free to the bar, I keep it running, the house shares each vend. Who makes that call?'),
    ("Father's Office", 'Culver City · Helms', T3, 'fathersofficeofficial', 'info@fathersoffice.com', 'photo booth for the Helms patio crowd?',
     ...
     'The Helms room is packed every night. A photo booth earns while people wait. Free to you, I service everything, the house takes a cut per strip. The group or the GM?\n\nThanks,\nChance'),
    ('Firestone Walker Propagator', 'Marina del Rey · Washington', T3, 'firestonewalker_propagator', None, None,
     ...
     'The Propagator is the one Firestone room a vintage booth fits. Free to the venue, I handle service, the house shares each vend. Local GM or corporate?'),
    ('LA Ale Works Culver City', 'Culver City · Ivy Station', T3, 'laaleworks', 'info@laaleworks.com', 'photo booth for the Ivy Station taproom?',
     ...
     'Trivia teams every Tuesday and the E Line outside. I put photo booths in taprooms. Free to you, serviced by me, revenue share on every strip. GM or ownership?\n\nThanks,\nChance'),
    ("Barney's Beanery Westwood", 'Westwood Village', T3, 'barneysbeaneryww', 'info@barneysbeanery.com', 'photo booth for the Westwood room?',
     ...
     'Karaoke Thursdays two blocks from campus. Students would print these. Free booth, I maintain it, the house takes a cut per vend. Who decides for Westwood?\n\nThanks,\nChance'),
    ("Rocco's Tavern Westwood", 'Westwood Village', T3, 'roccoswestwood', None, None,
     ...
     'Live band karaoke plus every UCLA game. I put photo booths in westside bars. Free to you, service included, the house shares each strip. In house or group level?'),
    ('The Chestnut Club', 'Santa Monica · 14th St', T3, 'thechestnutclub', 'marketing@happytoserveyou.com', 'photo booth for Chestnut?',
     ...
     'Zero TVs on purpose. A vintage photo booth is the one machine that fits that. Free to you, I handle everything, the house takes a cut per strip. Who makes that call?\n\nThanks,\nChance'),
    ('Library Alehouse', 'Santa Monica · Main St', T3, 'libraryalehouse', 'info@libraryalehouse.com', 'photo booth for the Alehouse?',
     ...
     "A film look booth fits the wood paneling. I place them free, service everything, the house shares each vend. Owners' decision or GM?\n\nThanks,\nChance"),
    ('The Brixton', 'Santa Monica · Pico', T3, 'thebrixtonsm', 'events@thebrixtonsm.com', 'photo booth for the Brixton?',
     ...
     "Latin Nights and bottomless Saturdays are photo crowds. Free booth, I keep it running, the house takes a cut per strip. Who's the right person?\n\nThanks,\nChance"),
    ('The Mulberry', 'Sawtelle Japantown', T3, 'themulberryla', None, None,
     ...
     'Only bar open past midnight on Sawtelle. I put photo booths in late rooms. Free to you, service included, the house shares each vend. Too new or good timing?'),
    ('El Segundo Brewing', 'El Segundo · Main St', T3, 'esbcbrews', 'info@elsegundobrewing.com', 'photo booth for the taproom?',
     ...
     'People pilgrimage for Broken Skull. Give them proof to take home. Free booth, I maintain it, the house takes a cut per strip. Floor space for a phone booth footprint?\n\nThanks,\nChance'),
    ('Brewport Tap House', 'El Segundo · Main St', T3, 'brewporttaphouse', None, None,
     ...
     'Sixty self pour taps. A coin operated photo booth fits the self serve idea. Free to you, I service it, the house shares each vend. GM or ownership?'),
]
